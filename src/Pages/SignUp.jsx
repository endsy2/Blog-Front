...
import { register } from "../Fetch-Data/FetchAPI";
...
const SignUp = () => {
  ...
  return (
    <section>
      <h2 className="font-AntonSC font-bold text-center text-primary text-5xl">Register</h2>
      <div className="flex flex-col align-center items-center p-20">
        <form onSubmit={handleSignUp}>
          ...
          <input
            ...
            className="text-xl ml-[70px] rounded-lg w-[500px] h-12 p-4"
            value={username}
          ...
          <input
            type="email"
            placeholder="Email"
            className="text-xl ml-[135px] rounded-lg w-[500px] h-12 p-4"
            value={email}
          ...
          <input
            ...
            className="text-xl ml-[80px] rounded-lg w-[500px] h-12 p-4"
            value={password}
          ...
          <input
            ...
            className="text-xl ml-[125px] text-center w-[500px] h-12 text-primary"
            required
          />
